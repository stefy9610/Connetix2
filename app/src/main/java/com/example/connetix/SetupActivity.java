...
public class SetupActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        ProfileImage = (CircleImageView) findViewById(R.id.setup_profil_image);
                ...
                filePath.putFile(resultUri).addOnCompleteListener(new OnCompleteListener<UploadTask.TaskSnapshot>() {
                    ...
                    public void onComplete(@NonNull Task<UploadTask.TaskSnapshot> task) {
                        if(task.isSuccessful()) {
                            Toast.makeText(SetupActivity.this, "Profile image stored successfully to Storage", Toast.LENGTH_SHORT).show();
    ...
    private void SaveAccountSetupInformation() {
        ...
        if(TextUtils.isEmpty(username)) {
            ...
            loadingBar.setTitle("Saving Informations");
            loadingBar.setMessage("Please wait, we are updating your account details");
            loadingBar.show();
            loadingBar.setCanceledOnTouchOutside(true);
            ...
            userMap.put("status", "Hi, I am using Connetix");
            ...
            UsersRef.updateChildren(userMap).addOnCompleteListener(new OnCompleteListener() {
                ...
                public void onComplete(@NonNull Task task) {
                    if(task.isSuccessful()) {
                        ...
                        Toast.makeText(SetupActivity.this, "Your account is successfully updated", Toast.LENGTH_LONG).show();
                        loadingBar.dismiss();
                    }
                    else {
                        String message = task.getException().getMessage();
