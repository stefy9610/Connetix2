...
public class LoginActivity extends AppCompatActivity {
    ...
    public void onActivityResult(int requestCode, int resultCode, Intent data) {
        ...
        if (requestCode == RC_SIGN_IN) {
            loadingBar.setTitle("Google Sing In");
            loadingBar.setMessage("Please wait, we login using your google account");
            ...
            if(result.isSuccess()) {
                ...
                Toast.makeText(this, "Can't get your auth result",Toast.LENGTH_SHORT).show();
                loadingBar.dismiss();
            }
        }
    }
    ...
    private void AllowingUserToLogin() {
        ...
        else
        {
            ...
            loadingBar.setMessage("Please wait, we login you into your account");
            loadingBar.setCanceledOnTouchOutside(true);
            loadingBar.show();
